...
import com.training.pom.TrashmessagePOM;
import com.training.utility.DriverFactory;
import com.training.utility.DriverNames;

public class CYTC_025Trashmessage {
	private WebDriver driver;
	private String baseUrl;
	private static Properties properties;
	private ScreenShot screenShot;
	private TrashmessagePOM mesPOM;
...
//		loginPOM = new DisplayinformationloanPOM
		mesPOM = new TrashmessagePOM(driver);
	...
	public void validLoginTest() throws InterruptedException {
		...
		mesPOM.clickpersonalBtn();
		Thread.sleep(1000);

		mesPOM.clickmessageBtn();
		Thread.sleep(1000);

		mesPOM.clicdeleteBtn();
		Thread.sleep(1000);
